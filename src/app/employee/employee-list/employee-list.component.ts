...
export class EmployeeListComponent implements OnInit {  
  ...
  ngOnInit(): void {  
    ...
    //This connection will be listening to the messages from SignlarR hub from backend Web API. Whenever, 
    //backend sends a message, getEmployeeData method will be triggered automatically.
